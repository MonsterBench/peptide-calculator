---
title: "BPC-157: Complete Research Guide — Dosage, Reconstitution & Protocols"
description: "Everything you need to know about BPC-157 for research: dosing protocols, reconstitution instructions, stacking with TB-500, and where to buy with 5% off."
date: "2026-02-10"
...
For an in-depth resource on preserving peptide integrity, read our guide on [Peptide Storage and Stability](/blog/peptide-storage-stability).
...
**[Shop BPC-157 -- 5% Off with code DKE4PDRM](https://peptiderestore.com/peptides/bpc-157?discount=DKE4PDRM)**

## Frequently Asked Questions

### What is the standard BPC-157 dosage for research?

The most commonly used BPC-157 dosage in preclinical studies is **10 mcg/kg body weight**, administered once or twice daily via subcutaneous injection. This dose has consistently produced significant results across tendon, muscle, GI, and nerve injury models. Use our [reconstitution calculator](/calculator) to determine the exact injection volume for your target dose.

### How do I reconstitute BPC-157?

BPC-157 reconstitution involves adding bacteriostatic water to the lyophilized powder vial. For a 5 mg vial, adding 2 mL of BAC water yields a concentration of 2,500 mcg/mL. Always inject the solvent slowly along the vial wall and swirl gently -- never shake. See our complete [reconstitution guide](/blog/how-to-reconstitute-peptides) for detailed instructions.
...
Reconstituted BPC-157 should be stored in the refrigerator at 2-8 degrees Celsius and used within 28-30 days. Always use bacteriostatic water as your solvent and maintain sterile technique when drawing from the vial. Read our full [storage and stability guide](/blog/peptide-storage-stability) for best practices.
