---
title: "Bacteriostatic Water: What It Is, Why You Need It, and How to Use It"
description: "The complete guide to bacteriostatic water for peptide research — what makes it different from sterile water, how to use it, shelf life, and where to get it."
date: "2026-02-03"
readTime: "7 min read"
...
I won't rehash the entire reconstitution process here — we've got a [full step-by-step reconstitution guide](/blog/how-to-reconstitute-peptides) that covers it in detail. But here's the short version:

1. **Swab everything.** Alcohol wipe on the BAC water vial stopper and the peptide vial stopper. Let them air dry for a few seconds.
2. **Draw your BAC water.** Use a clean syringe (1-3 mL) to pull out the volume you've decided on. Common choices are 1 mL or 2 mL per peptide vial.
3. **Inject slowly into the peptide vial.** Aim the stream against the glass wall, not directly onto the powder. Let the water trickle down and pool at the bottom.
4. **Swirl gently.** Never shake. Tilt the vial and roll it between your fingers until the powder dissolves completely. If it doesn't dissolve right away, set it in the fridge for 20-30 minutes and check again.
5. **Label and refrigerate.** Write the peptide name, date, concentration, and volume on the vial. Store at 2-8°C.

Need help with the math? Our [peptide reconstitution calculator](/calculator) will tell you the exact concentration and how many syringe units to draw for your target dose.
...
[Shop at Peptide Restore — 5% off](https://peptiderestore.com?discount=DKE4PDRM) for BAC water, syringes, alcohol swabs, and everything else you need for peptide reconstitution. They carry pharmaceutical-grade supplies and ship fast.
...
For the full reconstitution walkthrough, head over to our [step-by-step reconstitution guide](/blog/how-to-reconstitute-peptides). And for tips on keeping your reconstituted peptides viable as long as possible, check out our [peptide storage and stability guide](/blog/peptide-storage-stability).

**Need supplies?** [Shop at Peptide Restore — 5% off](https://peptiderestore.com?discount=DKE4PDRM) for bacteriostatic water, syringes, alcohol swabs, and research peptides.
